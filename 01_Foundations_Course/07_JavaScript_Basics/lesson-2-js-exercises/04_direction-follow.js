...
const lastName = "Reedy";
const thisYear = 2023;
const birthYear = 1997;

const greeting = `Hello! My name is ${firstName} ${lastName} and I am (thisYear - birthYear) years old.`;

// johndreedy prediction: "Hello! My name is Carlos Stevenson and I am 17 years old."

console.log(greeting);

// johndreedy comments, step 2: "Now my version, including backticks for readability."
...
// johndreedy comments, step 3: "Code executes successfully!"
